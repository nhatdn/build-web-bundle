...
const PartnerComponent = () => {
  ...
  return (
    <div id="partner" className="w-full bg-no-repeat bg-cover bg-mb-partner">
      <div className="w-full p-3 pt-4 sm:p-6">
        ...
        <div className="grid w-full grid-cols-1 mt-8 text-center md:grid-cols-3 sm:grid-cols-2">
          <img src={ItemEvan} alt="" className="w-[220px] lg:w-[300px] m-auto py-3" />
          <img src={ItemRkei} alt="" className="w-[220px] lg:w-[300px] m-auto py-3" />
          <img src={ItemCabo} alt="" className="w-[220px] lg:w-[300px] m-auto py-3" />
        </div>
      </div>
            ...
            <div>
              <Slider {...settings}>
                <div className="space-y-4">
                  <img src={Item1} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item2} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item3} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item4} alt="" className="h-[110px] md:h-[130px] m-auto" />
                </div>
                <div className="space-y-4">
                  <img src={Item5} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item10} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item7} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item8} alt="" className="h-[110px] md:h-[130px] m-auto" />
                </div>
                <div className="space-y-4">
                  <img src={Item9} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item11} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item12} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item13} alt="" className="h-[110px] md:h-[130px] m-auto" />
                </div>
                <div className="space-y-4">
                  <img src={Item14} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item15} alt="" className="h-[110px] md:h-[130px] m-auto" />
                  <img src={Item16} alt="" className="h-[110px] md:h-[130px] m-auto" />
                </div>
              </Slider>
            </div>
          </SlickWrapper>
