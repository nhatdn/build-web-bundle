import React, { ReactComponent, useRef } from 'react';
...
const AddictiveGameplayComponent = () => {
  ...
  return (
    <div id="gameplays" className="w-full bg-no-repeat bg-cover bg-mb-playgame">
              ...
              <Slider {...settings}>
                <div className="relative">
                  <div className="w-full md:block hidden">
                    <img src={Card_1} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="w-full block md:hidden">
                    <img src={Card_1_no_hero} alt="" className="w-full px-2 m-auto" />
                  </div>
                ...
                <div className="relative">
                  <div className="w-full md:block hidden">
                    <img src={Card_2} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="w-full block md:hidden">
                    <img src={Card_2_mb} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="absolute top-0 md:top-12 left-4 w-full">
                    <div className="pl-5 pr-11 text-white">
                      <div className="w-full ">
                        ...
                        <span className="text-sm md:text-lg font-medium">{translate('dcs-Adventure-Maps')}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="w-full md:block hidden">
                    <img src={Card_3} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="w-full block md:hidden">
                    <img src={Card_3_mb} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="absolute top-0 md:top-12 left-4 w-full">
                    <div className="pl-5 pr-11 text-white">
                      <div className="w-full ">
                        ...
                        <span className="text-sm md:text-lg font-medium">{translate('dcs-PvE')}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="w-full md:block hidden">
                    <img src={Card_4} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="w-full block md:hidden">
                    <img src={Card_4_mb} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="absolute top-0 md:top-12 left-4 w-full">
                    <div className="pl-5 pr-11 text-white">
                      <div className="w-full ">
                        ...
                        <span className="text-sm md:text-lg font-medium">{translate('dcs-PvP')}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="w-full md:block hidden">
                    <img src={Card_5} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="w-full block md:hidden">
                    <img src={Card_5_mb} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="absolute top-0 md:top-12 left-4 w-full">
                    <div className="pl-5 pr-11 text-white">
                      <div className="w-full ">
                        ...
                        <span className="text-sm md:text-lg font-medium">{translate('dcs-Bounty-Hunters')}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="w-full md:block hidden">
                    <img src={Card_6} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="w-full block md:hidden">
                    <img src={Card_6_mb} alt="" className="w-full px-2 m-auto" />
                  </div>
                  <div className="absolute top-0 md:top-12 left-4 w-full">
                    <div className="pl-5 pr-11 text-white">
                      <div className="w-full ">
                        ...
                        <span className="text-sm md:text-lg font-medium">{translate('dcs-Boss-Battle')}</span>
                      </div>
                    </div>
                  </div>
                </div>
