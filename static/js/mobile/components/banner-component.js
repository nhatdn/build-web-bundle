...
import { ReactComponent as IconClose } from '../assets/banner-top/xmark-solid.svg';
...
const BannerComponent = () => {
  return (
    <div id="home" className="w-full bg-no-repeat bg-cover bg-mb-banner pt-[24%] md:pt-[16%]">
      <div className="w-[90%] m-auto py-3">
        ...
        <p className="mt-3 font-medium text-justify">{translate('description-banner')}</p>
                  ...
                  <div className="relative w-full m-auto">
                    ...
                    <div className="absolute top-0 left-0 w-full h-auto p-3">
                      <div className="flex justify-end w-full h-4 pr-1">
                        <IconClose className="w-3 md:w-6 fill-white" onClick={close}></IconClose>
                      </div>
                      <div className="flex flex-col w-full gap-2 ">
                        <Popup
                          ...
                          trigger={
                            <a href="javascript:;" className="block" rel="noopener noreferrer">
                              <img src={DownloadIos} alt="" className="h-[30px]  m-auto" />
                            </a>
                          }
                        >
                          {(close) => <PopupComingSoon close={close} />}
                        ...
                        <a
                          ...
                          rel="noopener noreferrer"
                        >
                          <img src={DownloadAndroid} alt="" className="h-[30px]  m-auto" />
                        </a>
                        <a
                          ...
                          rel="noopener noreferrer"
                        >
                          <img src={DownloadPC} alt="" className="h-[30px]  m-auto" />
                        </a>
                      </div>
                    </div>
                  </div>
