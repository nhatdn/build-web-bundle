...
import {
    ReactComponent as IconFacebook
} from '../assets/social/facebook.svg';
import {
    ReactComponent as IconTelegram
} from '../assets/social/telegram.svg';
import {
    ReactComponent as IconTwitter
} from '../assets/social/twitter.svg';
import {
    ReactComponent as IconDiscord
} from '../assets/social/discord.svg';
import {
    ReactComponent as IconYoutube
} from '../assets/social/youtube.svg';
import {
    ReactComponent as IconReddit
} from '../assets/social/reddit.svg';
const SolialComponent = () => {
    return ( <
        ...
        className = "h-4 m-auto hover:fill-[#C09B62] hover:scale-150 hover:duration-300" / >
        <
        /a> <
