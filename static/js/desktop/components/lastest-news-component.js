...
const ItemSlideNews = ({
    ...
    return ( <
        ...
        className = "w-[380px] h-[220px] mb-6 outline-none px-4 hover:opacity-80 transition" >
        <
        a href = {
            href
        }
        ...
        <
        p className = "py-3 pr-4 text-xl font-bold text-white truncate" > {
            title
        } < /p> <
        p className = "pr-4 text-base text-white content-new" > {
            content
        } < /p> <
        /a> <
        /div>
...
const ItemEventNew = ({
    ...
    return ( <
        ...
        alt = "event"
        className = "h-[92px] w-[192px] object-cover rounded-2xl" / >
        <
        div className = "w-[calc(550px-210px)] h-full flex justify-center flex-col  text-white" >
        <
        p className = "w-full mb-2 text-xl font-bold truncate" > {
            dataCard.title
        } < /p> <
        p className = "w-full text-base content-new" > {
            dataCard.content
        } < /p> <
        /div> <
        /div> <
...
const LastestNewsComponent = () => {
    return ( <
        ...
        /div> <
        /div> <
        div id = "lastest-news-scrollable"
