      ...
      <div className="relative w-2/5 h-48 m-auto">
        ...
        <div className="absolute top-0 left-0 w-full p-3">
          <div className="flex justify-end w-full h-8 pr-1">
            <IconClose className="w-4 fill-white hover:cursor-pointer" onClick={close}></IconClose>
          </div>
          <p className="px-8 text-3xl font-medium text-center md:pt-3">{translate('coming-soon')}</p>
        </div>
      </div>
    </div>
  );
...
const FooterComponent = () => {
  return (
    <div className="flex flex-col w-full min-h-[715px] h-screen">
      <FagComponent key={'faq'} className="" />
          ...
          <div className="flex items-center justify-center gap-14">
            ...
            <div className="w-full grow h-44">
              ...
              <div className="flex justify-center w-full gap-8 pt-8 m-auto">
                <Popup modal trigger={<img src={IconAppStore} alt="App store" className="h-10" />}>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <img src={IconGg} alt="" className="h-10 m-auto" />
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <img src={IconWeb} alt="" className="h-10 m-auto" />
                </a>
              </div>
            </div>
            <img src={IconAudit} alt="Audit" className="w-48 m-auto" />
