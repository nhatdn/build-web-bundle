...
const BannerComponent = () => {
        return ( <
            ...
            <
            p className = "pt-4 font-medium text-black 2xl:text-base xl:text-sm" > {
            ...
            a href = ""
            target = ""
            className = "hover:text-[#3498db]" > #WorldOfMasters <
            /a> <
            a href = ""
            target = ""
            className = "hover:text-[#3498db]" > #WOFM <
            /a> <
            a href = ""
            target = ""
            className = "hover:text-[#3498db]" > #FreeToPlay <
            /a> <
            a href = ""
            target = ""
            className = "hover:text-[#3498db]" > #PlayToEarn <
            /a> <
            /p>
