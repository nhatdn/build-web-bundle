...
const MainDesktop = () => ( <
    ...
    anchor = {
        ['home', 'news', 'trailer', 'gameplays', 'roadmap', 'marketpalce', 'partner', 'document']
    }
    navigation = {
        true
    }
...
const Desktop = () => {
    ...
    return ( <
        ...
        <
        div className = {
            `w-screen h-screen fixed z-[9999] top-0 duration-1000 transition-all ${
